<div class="cardPlayers index">
	...
	<tr>
		...
		<td><?php echo h($cardPlayer['CardPlayer']['position']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($cardPlayer['Player']['player_id'], array('controller' => 'players', 'action' => 'view', $cardPlayer['Player']['player_id'])); ?>
		</td>
