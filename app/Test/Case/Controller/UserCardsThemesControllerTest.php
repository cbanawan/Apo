<?php
/* UserCardsThemes Test cases generated on: 2012-02-04 13:28:53 : 1328387333*/
 ...
 * @var array
 */
	public $fixtures = array('app.user_cards_theme', 'app.theme', 'app.user', 'app.user_card', 'app.card_variation', 'app.card', 'app.set', 'app.wiki_info', 'app.brand', 'app.acc_catalog', 'app.team', 'app.qualifier', 'app.user_cards_qualifier');
